package com.lin.linaicodemother.ratelimter.aspect;
 ...
 * @Author Lin
 * @Date 2026/7/6 21:44
 * @Descriptions 使用AOP 面向切面编程来实现限流逻辑。
 */
        ...
        switch (rateLimit.limitType()) {
            ...
            case APPID:
                ...
                for (int i = 0; i < method.getParameters().length; i++) {
                    ...
                    if ("appId".equals(value) || "appId".equals(param.getName())) {
                        appId = (Long) args[i];
                        break;
                    }
                }
                keyBuilder.append("appId:").append(appId);
                break;
            default:
